...
namespace Mkb.RavenDbRepo.Tests.RavenDbRepoTests.IRavenReaderRepoTests
{
    public class GetTests : RavenTestDriver
    {
        ...
        public async Task Ensure_we_can_Get_a_item()
        {
            ...
            var item =  repo.Get<Entity>(f => f.Id == thirdItem.Id);
        ...
        public async Task Ensure_we_can_order_by()
        {
            ...
            var item =  repo.Get<Entity>(null, f => f.Dob);
        ...
        public async Task Ensure_we_can_order_by_desc()
        {
            ...
            var item =  repo.Get<Entity>(null, f => f.Dob, true);
        ...
        public async Task Ensure_we_can_get_non_hard_deleted_items()
        {
            ...
            var item =  repo.Get<Entity>(f => f.Id == thirdItem.Id, includeSoftDelete: true);
        ...
        public async Task Ensure_we_can_get_item_with_projection()
        {
            ...
            var item =  repo.Get<Entity, DateTime>(f => f.Id == thirdItem.Id, f => f.Dob);
